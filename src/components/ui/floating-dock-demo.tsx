...
export const IconHome = ({ className = "h-full w-full" }: { className?: string }) => (
  <svg
...
export const IconBook = ({ className = "h-full w-full" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const IconClock = ({ className = "h-full w-full" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const IconChecklist = ({ className = "h-full w-full" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const IconChartBar = ({ className = "h-full w-full" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
